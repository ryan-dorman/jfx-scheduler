...
public class Appointment extends Base {
    ...
    /**
     * Constructor accepts no parameters to allow for empty class creation and dynamic property assignment post-creation.
     */
    public Appointment() {
    }

    /**
     * Constructor accepts all object properties and all <code>Base</code> properties to allow for easy object creation
     * when reading Appointment entities into the model with the DAOs.
     ...
     * @param updated The date and time the appointment was last updated at, <em>should</em> be assigned at data layer
     * @param updatedBy The source that updated the appointment
     */
    public Appointment(Long id, String title, String description, String location, String type, ZonedDateTime start,
                       ZonedDateTime end, long customerId, long userId, long contactId, ZonedDateTime created,
    ...
    /**
     * Constructor accepts all Appointment properties but none of the <code>Base</code> properties. Allows easy creation
     * of Appointment objects with data coming from the view layer.
     * @param title Title of the appointment
     * @param description Description of the appointment
     * @param location Location where the appointment will take place
     * @param type Type of appointment
    ...
    public Appointment(String title, String description, String location, String type, ZonedDateTime start,
                       ZonedDateTime end, long customerId, long userId, long contactId) {
        this.title = title;
        this.description = description;
        this.location = location;
        this.type = type;
